...
const string strMessageMagic = "CheckoutCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1)
        nSubsidy = 5000000 * COIN; // 5,000,000 coins for distribution
    else
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CheckoutCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        */
        ...
        const char* pszTimestamp = "zerohedge 11/3/2014 - Bill Gross Warns Global Economy & Financial Markets Are Insecurely Grounded";
        CTransaction txNew;
        txNew.nTime = 1415040587;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1415040587;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 261836 : 261836;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x29999ef8d2efd046e0b17e531a4300ff613652dabb485624acfb36aa4d4c676a"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xb4, 0xef, 0xf2, 0xfa };
