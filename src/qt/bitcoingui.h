...
private:
    ...
    QAction *myPriceSheetAction;
    QAction *dynamicPricingAction;
    QAction *myWebShopAction;
    QAction *snakeAction;
...
private slots:
    ...
    virtual void tickerTimer_timeout();
